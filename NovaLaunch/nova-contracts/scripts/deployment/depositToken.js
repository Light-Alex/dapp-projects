...
async function main() {
    ...
    // Approve and wait for transaction to be mined
    const approveTx = await token.approve(lastDeployedSale, ethers.utils.parseEther(c.totalTokens));
    await approveTx.wait();
    console.log(`token.approve(${lastDeployedSale}, ${c.totalTokens}) - confirmed`);
